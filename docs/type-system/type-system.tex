...
shadow} of the runtime oracle already in \texttt{src/}.
\end{abstract}
...
brute-force oracle in \texttt{src/} (Sec.~\ref{sec:code}).
...
Every rule corresponds to a function already in (or planned for) \texttt{src/},
